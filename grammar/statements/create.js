...
export default {
  ...
  // Oracle CREATE [OR REPLACE] TRIGGER (sqlrf/CREATE-TRIGGER.html).
  // Replaces the upstream PostgreSQL/MariaDB version. The body is an
  // Oracle PL/SQL block.
  create_trigger: $ => seq(
    $.keyword_create,
    optional($._or_replace),
  ...
  // Oracle DML triggering events. `INSERT`, `DELETE`, `UPDATE [OF cols]`.
